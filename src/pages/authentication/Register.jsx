...
const Register = () => {
  ...
  function handleSignInEmail(e) {
    ...
    setError("");
    createEmail(email, pass, name, photoURL).then((res) => {
      if (res) {
        Swal.fire({
        ...
        <form onSubmit={handleSignInEmail} className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              name="pass"
              className="w-full mt-1 px-4 py-2 border placeholder-gray-500 border-gray-300 rounded-xs l focus:ring-2 focus:ring-amber-400 outline-none"
            />
